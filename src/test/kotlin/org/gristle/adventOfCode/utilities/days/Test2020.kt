...
class Test2020 {
    ...
    internal fun y2020d7() {
        assertEquals("252" to "35487", Day.testDay(Y2020D7::class))
    }
    ...
    internal fun y2020d9() {
        assertEquals("552655238" to "70672245", Day.testDay(Y2020D9::class))
    }
    ...
    internal fun y2020d13() {
        assertEquals("115" to "756261495958122", Day.testDay(Y2020D13::class))
    }
    ...
    internal fun y2020d23() {
        assertEquals("94238657" to "3072905352", Day.testDay(Y2020D23::class))
    }
    ...
    internal fun y2020d25() {
        assertEquals("296776" to "skipped", Day.testDay(Y2020D25::class))
    }
}
