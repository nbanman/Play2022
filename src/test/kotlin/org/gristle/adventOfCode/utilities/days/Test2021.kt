...
class Test2021 {
    ...
    internal fun y2021d6() {
        assertEquals("361169" to "1634946868992", Day.testDay(Y2021D6::class))
    }
    ...
    internal fun y2021d10() {
        assertEquals("167379" to "2776842859", Day.testDay(Y2021D10::class))
    }
    ...
    internal fun y2021d13() {
        assertEquals("735" to "UFRZKAUZ", Day.testDay(Y2021D13::class))
    }

    @Test
    internal fun y2021d14() {
        assertEquals("3555" to "4439442043739", Day.testDay(Y2021D14::class))
    }
    ...
    internal fun y2021d18() {
        assertEquals("3806" to "4727", Day.testDay(Y2021D18::class))
    }

    @Test
    internal fun y2021d19() {
        assertEquals("378" to "13148", Day.testDay(Y2021D19::class))
    }
    ...
    internal fun y2021d21() {
        assertEquals("605070" to "218433063958910", Day.testDay(Y2021D21::class))
    }

    @Test
    internal fun y2021d22() {
        assertEquals("587097" to "1359673068597669", Day.testDay(Y2021D22::class))
    }
    ...
    internal fun y2021d24() {
        assertEquals("92969593497992" to "81514171161381", Day.testDay(Y2021D24::class))
    }

    @Test
    internal fun y2021d25() {
        assertEquals("528" to "skipped", Day.testDay(Y2021D25::class))
    }
}
