...
object Y2015D22 {
    ...
    data class State(
        ...
        fun cast(spell: Effect, constantDrain: Boolean): State {
            ...
            return State(newPlayerHP, newDead, newBossHP, newCurrentMana, newManaSpent, newShield, newPoison, newRecharge)
        }

        fun bossTurn(): State {
            val newPlayerHP = playerHP - maxOf(1, 10 - armor)
            ...
            return State(newPlayerHP, alreadyDead, newBossHP, newCurrentMana, manaSpent, newShield, newPoison, newRecharge)
        }
    ...
    private fun solve(constantDrain: Boolean): Int {
        ...
        states.add(State(50, false, 71, 500))
...
fun main() {
    ...
    println("Part 1: ${Y2015D22.part1()} (${elapsedTime(time)}ms)") // 1824
    time = System.nanoTime()
    println("Part 2: ${Y2015D22.part2()} (${elapsedTime(time)}ms)") // 1937
}