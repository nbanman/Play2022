...
object Y2017D7 {
    private val input = readRawInput("y2017/d7")

    const val pattern = """(\w+) \((\d+)\)(?: -> (.*))?"""
...
fun main() {
    ...
    println("Part 1: ${Y2017D7.part1()} (${elapsedTime(time)}ms)") // airlri
    time = System.nanoTime()
    println("Part 2: ${Y2017D7.part2()} (${elapsedTime(time)}ms)") // 1206
}