...
fun main() {
    ...
    println("\tPart 1: ${solver.part1()} (${timer.lap()}ms)") // 5073496 (33ms)
    println("\tPart 2: ${solver.part2()} (${timer.lap()}ms)") // 13081194638237 (3700ms)
    println("Total time: ${timer.elapsed()}ms") // (3838ms)
}