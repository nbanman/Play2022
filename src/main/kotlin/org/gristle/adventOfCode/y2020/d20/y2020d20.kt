...
object Y2020D20 {
    private val input = readStrippedInput("y2020/d20")
...
fun main() {
    ...
    println("Part 1: ${Y2020D20.part1()} (${elapsedTime(time)}ms)") // 19955159604613
    time = System.nanoTime()
    println("Part 2: ${Y2020D20.part2()} (${elapsedTime(time)}ms)") // 1639
}